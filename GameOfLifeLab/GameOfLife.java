...
public class GameOfLife
{
    ...
    private final int X1 = 3, Y1 = 4;
    private final int X2 = 4, Y2 = 3;
    private final int X3 = 4, Y3 = 4;
    private final int X4 = 4, Y4 = 5;
    private final int X5 = 5, Y5 = 2;
    private final int X6 = 5, Y6 = 3;
    private final int X7 = 5, Y7 = 4;
    private final int X8 = 5, Y8 = 5;
    private final int X9 = 5, Y9 = 6;
    ...
    public void createNextGeneration()
    {
        ...
        for (int row = 0; row<ROWS; row++)
        {
            for (int col = 0; col<COLS; col++)
            {
                ...
                ArrayList<Location> something = grid.getOccupiedAdjacentLocations(location);
                Actor cell = grid.get(location);
                if (cell != null)
                {
                    if (something.size() == 2 || something.size() == 3)
                    {
                        Rock rock = new Rock();
                        newGrid.put(location,rock);
                    }
                }
